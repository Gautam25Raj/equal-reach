...
const Sidebar = () => {
  ...
  return (
    <nav className="flex flex-row md:flex-col order-last md:order-first items-center bg-white w-full justify-center md:justify-start  md:mt-5 mx-auto md:items-start xl:px-4">
      <Image
