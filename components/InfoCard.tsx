const InfoCard = () => {
  return (
    <div className="flex flex-col p-5 md:flex-row justify-center items-center mb-10 text-center xl:px-16">
      ...
      <p className=" py-8 max-w-xl text-sm lg:text-base md:px-10 xl:px-16 md:text-md md:text-left">
      ...
      <button className="py-2 px-7 text-xs border-4 border-rainbow rounded-3xl w-fit  ">
        About Us
      </button>
    </div>
  );
